...
ActiveRecord::Schema.define(version: 20161114083857) do
  ...
  create_table "bookmark_stats", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["state"], name: "index_bookmark_stats_on_state", using: :btree
  end
  ...
  create_table "order_list_transitions", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.boolean  "most_recent"
    t.index ["order_list_id"], name: "index_order_list_transitions_on_order_list_id", using: :btree
    t.index ["sort_key", "order_list_id"], name: "index_order_list_transitions_on_sort_key_and_order_list_id", unique: true, using: :btree
  end
  ...
  create_table "order_lists", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["bookstore_id"], name: "index_order_lists_on_bookstore_id", using: :btree
    t.index ["user_id"], name: "index_order_lists_on_user_id", using: :btree
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["order_list_id"], name: "index_orders_on_order_list_id", using: :btree
    t.index ["purchase_request_id"], name: "index_orders_on_purchase_request_id", using: :btree
  end
  ...
  create_table "purchase_requests", force: :cascade do |t|
    ...
    t.string   "state"
    t.string   "pub_date"
    t.index ["state"], name: "index_purchase_requests_on_state", using: :btree
